...
class ApplicationsLogoHandler(GenericApplicationHandler):
    ...
    def post(self):
        ...
        if img.size[0] != 165 or img.size[1] != 28:
            ...
            msg = 'The size of the image is not according to the compliance' \
                  ...
                  ' dimensions (165px width and 28px height).'
...
class ApplicationsCLHandler(GenericApplicationHandler):
    ...
    def post(self):
        ...
        file_name = self.json_args['company_logo']
        company_logo_name = file_name.rsplit('.', 1)[0]
        extension_name = file_name.split('.')[-1]

        company_logo_name = slugify(company_logo_name)
        self.json_args['company_logo'] = \
            company_logo_name + '.' + extension_name
        self._post()
