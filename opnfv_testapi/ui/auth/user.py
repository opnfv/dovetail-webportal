        ...
        if openid:
            try:
                ...
                self.finish_request({
                    ...
                    "ventorName": user.get('ventorName'),
                    "ventorEmail": user.get('ventorEmail'),
                    "ventorPhone": user.get('ventorPhone'),
...
class User(models.ModelBase):
    def __init__(self, _id=None, openid=None, email=None, fullname=None,
                 ...
                 organizationWebsite=None, ventorName=None, ventorEmail=None,
                 ventorPhone=None, companyName=None, companyLogo=None,
                 primaryContactName=None, primaryBusinessEmail=None,
                 primaryPostalAddress=None, primaryPhoneNumber=None):
        self._id = _id
        self.openid = openid
        self.email = email
        ...
        self.ventorName = ventorName
        self.ventorEmail = ventorEmail
        self.ventorPhone = ventorPhone
